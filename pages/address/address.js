...
Page({
    ...
    bindEditAddressTap: function (e) {
        ...
        wx.navigateTo({
          url: '../editaddress/editaddress?extra=' + JSON.stringify(addressData) + '&title=编辑收货地址&Source=' + this.data.pageurl + '&shopBranchId=' + this.data.shopBranchId + (isupdate ? '&isupdate=1' : '') + '&frompage=' + this.data.pageurl
        }); 
    },
    gotoAddAddress: function () {
        wx.navigateTo({
          url: '../editaddress/editaddress' + '?title=新增收货地址&Source=' + this.data.pageurl + '&shopBranchId=' + this.data.shopBranchId + '&frompage=' + this.data.pageurl
        });

App({
                            ...
                            success: function(wxuser) {
                                ...
                                wx.request({
                                    ...
                                    success: function(result) {
                                        ...
                                        if (result.success) {
                                          wx.request({
                                            url: 'https://api.mangoauto.com.cn/Wx/GetUnionid.ashx',
                                            header: {
    ...
    orderPay(orderid, orderstatus, islistpage, isLease) {
        var that = this;
   ...
   getRequestUrl: 'https://www.qishoug.com/',
    //  getRequestUrl: 'http://10.13.17.233:8067/',
    getUrl(route) {
     return `https://www.qishoug.com/smallprogapi/${route}`;
    //   return `http://10.13.17.233:8067/smallprogapi/${route}`;
    },
    ...
    globalData: {
        appId: 'wxeda55aa2a6954e75',
        secret: '091db23379492f965cfe29494fd3ea7c',
        userInfo: null,
        openId: '',
        wxUserInfo: null,
        CellPhone: '',
        users: [], // openid 2019.09.24
        IsStationMaster: 0, // 是否可以进行老带新 2020.12.01
        qsgUserInfo:null,   //QSG用户信息（调取token）
        QQMapKey: 'KBABZ-URQLU-MQAVW-2W3O7-FDSRT-5KFP5',
        ...
        SaveMemberOldNewInfo:  "MemberCapital/SaveMemberOldNewInfo",  // 老带新关系绑定（作废）
        SaveMemberOldNewInfoByStatusCode:  "MemberCapital/SaveMemberOldNewInfoByStatusCode",  // 老带新关系保存
        getMemberOldNewInfo: "MemberCapital/GetMemberOldNewInfoByOldMemberId", // 获取当前用户的老带新关系
        CheckMemberOldInfo: "MemberCapital/CheckMemberOldInfo", // 判断是否为老骑手（是否有老带新资格）
        GetMemberOldNewInfoByNewMemberId:  "MemberCapital/GetMemberOldNewInfoByNewMemberId",  // 查看新客户是否已经绑定
        getCartProduct: "Cart/GetCartProduct", //获取购物车列表
        getAddToCart: "Cart/GetAddToCart",
        InviteRegist:  "Register/InviteRegist", //自动注册
        ...
        orderDepositList: "UserOrder/GetDepositOrders", //获取押金订单列表
        ...
        orderSubmitModelRenew: "Order/GetSubmitModelRenew", //续期订单
        ...
        GetPhoneCheckCode: "Login/GetPhoneCheckCode",   //获取验证码(登录)
      GetCheckPhoneCheckCode: "Login/GetCheckPhoneCheckCode",//验证手机验证码(登录)
        ...
        GetWxAcode: "Login/GetWxAcode", //获取小程序二维码
        LoginByCertificate: "Login/PostLoginByPhone",  //验证码登录
        LoginByCertificateOrRegist: "Login/LoginByCertificateOrRegist",  //验证码登录
        GetChargeDetailInfoByLease: "MemberCapital/GetChargeDetailInfoByLease", // 获取是否存在有效租赁电池订单接口
        GetLvwoBilltemplateInfo: "MemberCapital/GetLvwoBilltemplateInfo" // 获取计费模板的接口
    }
})